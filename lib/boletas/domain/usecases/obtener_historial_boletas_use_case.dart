...
class ObtenerHistorialBoletasUseCase {
  ...
  Future<HistorialBoletasSuccessResponse> execute({int? page}) async {
    ...
    final response = await boletasRepository.obtenerHistorialBoletas(usuario.nroAfiliado, page: page);
